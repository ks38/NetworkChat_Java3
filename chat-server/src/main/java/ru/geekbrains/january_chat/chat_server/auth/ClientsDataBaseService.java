...
import ru.geekbrains.january_chat.chat_server.server.ClientHandler;
...
public class ClientsDataBaseService {
    ...
    private static final Logger dbLog = LogManager.getLogger(ClientsDataBaseService.class);
    ...
    public String getClientsNameByLoginPass(String login, String password) {
        try {
            ...
            if (res.next()) {
                ...
                res.close();
                dbLog.info("dbLOG_INFO: Login is - " + result);
